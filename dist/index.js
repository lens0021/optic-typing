/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    /***/ 99: /***/ (module, __webpack_exports__, __webpack_require__) => {
      ...
      ___CSS_LOADER_EXPORT___.push([
        module.id,
        'body{padding:0;margin:0;background-color:gray}body.wrong{background-color:#c08080}.canvas{background-color:#fff;position:fixed;left:10%;top:10%;width:80%;height:80%;box-shadow:2em 2em 2em;cursor:none}.target{position:absolute;width:15rem;height:15rem;margin-left:-7.5rem;margin-top:-7.5rem;text-align:center;line-height:15rem;border:.2em solid orange;border-radius:15rem;font-size:2em;top:50%;left:50%;transition-property:top left;transition-duration:100ms}.canvas.inverse .target{background-color:#000;color:#fff}.checks{position:fixed;top:1em;right:1em}.size{font-size:5em;text-align:center;background-color:#fff;width:5em;margin-left:calc(50% - 2.5em);box-shadow:inset .1em .1em .2em}.caution{font-size:5em;text-align:center;position:absolute;bottom:0;left:0;right:0;margin-bottom:.2em}',
        '',
      ]);
      // Exports
...
*/
  ...
  (() => {
    ...
    var styles = __webpack_require__(99); // CONCATENATED MODULE: ./src/styles.scss
    var options = {};
    ...
    /* harmony default export */ const src_styles =
      styles /* default */.Z && styles /* default.locals */.Z.locals
        ? styles /* default.locals */.Z.locals
        : undefined; // CONCATENATED MODULE: ./src/index.ts
    ...
    class OpticTyping {
      ...
      match(expected, actual) {
        ...
        if (actual == 'arrowdown' && arrows['down'].indexOf(expected) >= 0) {
          ...
          actual == 'arrowleft' &&
          arrows['left'].indexOf(expected) >= 0
        ) {
          return true;
        } else if (
          actual == 'arrowright' &&
